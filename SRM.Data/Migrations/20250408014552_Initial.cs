        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TongKinhPhi = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    NgayBatDau = table.Column<DateTime>(type: "datetime2", nullable: true),
                    NgayKetThuc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    KinhPhiHangNam = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChiSoTacDong = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    ...
                    DiemHoiDong = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    TenHoiDong = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LoaiQ = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ThanhQuaId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000001"), null, null, null, null, null, null, null, null, null, null, null, null, "AQAAAAIAAYagAAAAENKmRj5jqegps3RqNwm9hCkccpMsKxFAP7p4ty/6/pZLIpwIiecVJv/cnGIQP/3PBQ==", null, null, "admin" });
