    ...
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<CongBo, CongBoData>()
                ...
                .ForMember(dest => dest.TacGiaChinh, opt => opt.MapFrom(src => src.TacGiaChinh != null ? JsonSerializer.Deserialize<TacGiaJson>(src.TacGiaChinh, options) : null))
                .ForMember(dest => dest.TacGiaLienHe, opt => opt.MapFrom(src => src.TacGiaLienHe != null ? JsonSerializer.Deserialize<TacGiaJson>(src.TacGiaLienHe, options) : null))
                .ForMember(dest => dest.DongTacGias, opt => opt.MapFrom(src => src.DongTacGias != null ? JsonSerializer.Deserialize<List<TacGiaJson>>(src.DongTacGias, options) : null))
                .ReverseMap()
            ...
            CreateMap<DeTai, DeTaiData>()
                ...
                .ForMember(dest => dest.ChuNhiem, opt => opt.MapFrom(src => src.ChuNhiem != null ? JsonSerializer.Deserialize<TacGiaJson>(src.ChuNhiem, options) : null))
                .ForMember(dest => dest.CanBoThamGias, opt => opt.MapFrom(src => src.CanBoThamGias != null ? JsonSerializer.Deserialize<List<TacGiaJson>>(src.CanBoThamGias, options) : null))
                .ReverseMap()
            ...
            CreateMap<HoatDong, HoatDongData>()
                ...
                .ForMember(dest => dest.ChuNhiem, opt => opt.MapFrom(src => src.ChuNhiem != null ? JsonSerializer.Deserialize<TacGiaJson>(src.ChuNhiem, options) : null))
                .ForMember(dest => dest.ThanhVienThamGias, opt => opt.MapFrom(src => src.ThanhVienThamGias != null ? JsonSerializer.Deserialize<List<TacGiaJson>>(src.ThanhVienThamGias, options) : null))
                .ReverseMap()
                .ForMember(dest => dest.ChuNhiem, opt => opt.MapFrom(src => src.ChuNhiem != null ? JsonSerializer.Serialize(src.ChuNhiem, options) : null))
